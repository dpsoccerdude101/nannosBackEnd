...
$query = "SELECT Orders.OrderId, Orders.DateTimeOfOrder, RetailStore.StoreName, Orders.Status
 FROM Orders, RetailStore 
 WHERE Orders.VendorId = '$data->VendorID'
 AND Orders.Status = 'pending'
 AND Orders.StoreId = RetailStore.StoreId";
